...
export const products = [
  {
    product_code: "P1001",
    name: "Women Casual Cotton Kurti",
    description:
      "Lightweight cotton kurti with a straight fit, perfect for casual wear and office outfits.",
  ...
  },
  {
    ...
    description:
      "Slim fit stretchable denim jeans designed for comfort and durability.",
  ...
  },
  {
    ...
    description:
      "Soft cotton T-shirt with fun cartoon prints, perfect for everyday wear.",
    image: [p_img2_1],
    color: ["Red", "Yellow"],
    size: ["S", "M", "L"],
    brand: "KiddyStyle",
...
//   {
//     product_code: "P1004",
//     name: "Women Sports Running Shoes",
//     description:
//       "Breathable and lightweight running shoes with cushioned sole for active lifestyle.",
//     image: [p_img2_1, p_img4],
//     color: ["Pink", "Grey"],
//     size: ["5", "6", "7", "8"],
//     brand: "FlexRun",
//     category: "Women",
...
//   },
  {
    ...
    description:
      "Classic genuine leather belt with premium buckle design, perfect for office wear.",
    image: [p_img5],
    color: ["Black", "Brown"],
    size: ["M", "L", "XL"],
    brand: "Formelix",
  ...
  {
    product_code: "P1006",
    name: "Unisex Smart Fitness Watch",
    description:
      "Smartwatch with heart rate monitor, step counter, and notification alerts.",
    image: [p_img6, p_img7],
    color: ["Black", "Silver"],
    size: ["One Size"],
    brand: "TechPulse",
